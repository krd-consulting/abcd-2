            ...
            $( "#dialog-form" ).dialog({
                    ...
                    buttons: {
                            "Add Record!": function() {
                                    ...
                                    bValid = bValid && checkLength( username, "Username", 4, 22 );
                                    //bValid = bValid && checkRegexp( username, /^[a-z]([a-z-_])+$/i, "Username can only contain letters, dashes and underscores." );
                                    ...
                                    bValid = bValid && checkRegexp( email, /^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/i, "Please check phone number format.");
                                 
                                    bValid = bValid && checkLength( password, "Password", 3, 12 );
