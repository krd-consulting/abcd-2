    ...
    function() {
        ...
        dhtmlxEventable(scheduler), scheduler._detachDomEvent = function(e, t, i) {
                ...
                if (this._cols) {
                    ...
                    if (t = r + (this._cols[r] ? (e - i) / this._cols[r] : 0), this._ignores && t >= this._cols.length)
            ...
            function() {
                ...
                this._events = {},
                    this._loaded = {}, this._edit_id = null, this._select_id = null, this._drag_id = null, this._drag_mode = null, this._drag_pos = null, this.clear_view(), this.callEvent("onClearAll", [])
                ...
                (t || this.callEvent("onBeforeEventDelete", [e, i]) && this.callEvent("onConfirmedBeforeEventDelete", [e, i])) && (i && (this._select_id = null,
                    delete this._events[e], this.event_updated(i)), this.callEvent("onEventDeleted", [e, i]))
            ...
            function() {
                for (var e = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate"], t = function(e) {
                    ...
                    }, r = 0; r < e.length; r += 2) scheduler["getEvent" + e[r + 1]] = t(e[r]),
                    scheduler["setEvent" + e[r + 1]] = i(e[r])
                ...
                for (var t = this._rendered_location, i = this._lame_clone(e), r = e._sday; r < e._eday; r++) {
                    ...
                    l.onclick = function(e) {
                        ...
                        }, l.className = "dhx_month_link", l.style.top = d.y + "px", l.style.left = d.x + "px", l.style.width = o + "px", l.innerHTML = scheduler.templates.month_events_link(a, n),
                        this._rendered.push(l), t.appendChild(l)
                }
                ...
                for (var s = 0; s < e.length; s++) {
                    ...
                    if (a._sday = this._get_event_sday(a), this._ignores[a._sday]) e.splice(s, 1), s--;
                        ...
                        }(o < this.config.first_hour || l >= this.config.last_hour) && (r.push(a), e[s] = a = this._copy_event(a), o < this.config.first_hour && (a.start_date.setHours(this.config.first_hour), a.start_date.setMinutes(0)), l >= this.config.last_hour && (a.end_date.setMinutes(0), a.end_date.setHours(this.config.last_hour)), a.start_date > a.end_date || o == this.config.last_hour) && (e.splice(s, 1), s--)
                    }
                }
                if (!t) {
                ...
                for (var i, r = [], s = [
                    ...
                    if (l._sday = g % n, !this._ignores[l._sday] || !l._timed) {
                        ...
                        if (l._sorder && t || (l._sorder = v),
                            l._sday + l._length <= n) i = null, r.push(l), m[v] = l, a[l._sweek] = m.length - 1, l._first_chunk = _.first_chunk, l._last_chunk = _.last_chunk;
                        else {
            ...
            scheduler.ical = {
                ...
                this._edit_stop_event(scheduler.getEvent(this._lightbox_id), e), e && scheduler.render_view_data(), this.hideCover(t), this._custom_lightbox && (this._lightbox = this._temp_lightbox, this._custom_lightbox = !1), this._temp_lightbox = this._lightbox_id = null, this._waiAria.lightboxHiddenAttr(t), this.callEvent("onAfterLightbox", [])
                        ...
                        if (t && i) switch (i) {
                            ...
                            default:
                                if (t.getAttribute("dhx_button")) scheduler.callEvent("onLightboxButton", [i, t, e]);
                                    ...
                                    var s, a, n; - 1 != i.indexOf("dhx_custom_button") && (-1 != i.indexOf("dhx_custom_button_") ? (s = t.parentNode.getAttribute("index"), n = t.parentNode.parentNode) : (s = t.getAttribute("index"), n = t.parentNode, t = t.firstChild)), s && (a = scheduler.form_blocks[scheduler.config.lightbox.sections[s].type], a.button_click(s, t, n, n.nextSibling))
                                }
                        }
                    }
                ...
                if (scheduler._dnd_start_lb) {
                    ...
                    t.style.top = scheduler._lb_start[1] + i[1] - scheduler._dnd_start_lb[1] + "px",
                        t.style.left = scheduler._lb_start[0] + i[0] - scheduler._dnd_start_lb[0] + "px"
                }
                ...
                if (!this._lightbox) {
                    ...
                    t += "</div>", e.innerHTML = t, scheduler.config.drag_lightbox && (e.firstChild.onmousedown = scheduler._ready_to_dnd, e.firstChild.onselectstart = function() {
                            return !1
                        }, e.firstChild.style.cursor = "pointer", scheduler._init_dnd_events()),
                        this._waiAria.lightboxAttr(e), document.body.insertBefore(e, document.body.firstChild), this._lightbox = e;
                    ...
                    scheduler._bindLightboxLabels(a), this.setLightboxSize(), this._init_lightbox_events(this), e.style.display = "none",
